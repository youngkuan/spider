...
public class ZhihuProcessor implements PageProcessor{
    private static String facetTable = "facet";
    ...
    public static void main(String[] args){
        ...
        //1.获取分面名
        ZhihuProcessorDAO zhihuProcessorDAO = new ZhihuProcessorDAO();
        List<Map<String, Object>> allFacetsInformation = zhihuProcessorDAO.getAllFacets(facetTable);
        //2.添加连接请求
